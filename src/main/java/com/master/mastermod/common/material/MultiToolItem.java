...
public class MultiToolItem extends ToolItem {
    ...
    public float getDestroySpeed(ItemStack stack, BlockState state)
    {
        ...
        if (block == Blocks.COBWEB)
        {
            ...
            return material != Material.WOOD && material != Material.NETHER_WOOD && material != Material.BAMBOO && material != Material.CORAL && material != Material.LEAVES && material != Material.VEGETABLE && material != Material.METAL && material != Material.HEAVY_METAL && material != Material.STONE ? super.getDestroySpeed(stack, state) : this.speed;
        }
    }
